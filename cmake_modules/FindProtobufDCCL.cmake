...
function(PROTOBUF_GENERATE_PYTHON SRCS)
  ...
  foreach(FIL ${ARGN})
    ...
    list(APPEND ${SRCS} "${CMAKE_CURRENT_BINARY_DIR}/dccl/${FIL_WE}_pb2.py")
    
    add_custom_command(
      OUTPUT "${CMAKE_CURRENT_BINARY_DIR}/dccl/${FIL_WE}_pb2.py"
      COMMAND  ${PROTOBUF_PROTOC_EXECUTABLE} --proto_path ${dccl_INC_DIR} --python_out ${CMAKE_CURRENT_BINARY_DIR} -I ${PROTOBUF_INCLUDE_DIRS} -I ${dccl_INC_DIR} ${ABS_FIL}
      DEPENDS ${ABS_FIL}
